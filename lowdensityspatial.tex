...
{Author \MakeLowercase{\textit{et al.}}: Low Density EEG Spatial Resolution and Connectivity}
\begin{document}
\title{Low Density EEG Spatial Resolution and Connectivity}
\author{M. Pretel, \IEEEmembership{Fellow, IEEE}, Second B. Author, and Third C. Author, Jr., \IEEEmembership{Member, IEEE}
...
\begin{abstract}
Electroencephalograhy (EEG) is known due to their very low spatial resolution.  However, recent advances in source projection and inverse problem
allowed to create very accurate scalp maps and connectivity maps that represent with higher confidence the activity found in different brain regions.  
This process is mostly based on high-density EEG devices.  However, work analyzing how far good projections can be achieved with lower number of electrodes, and particularly with very low-density EEG devices has been scarce.  This work tackles this problem and analyze different alternatives to perform source projection and connectivity analysis on a known dataset of sleep research and bla bla bla bla bla 
\end{abstract}
...
beginning of a sentence: ``Reference \cite{Chen.etal2022} shows $\ldots$ .'' Please do not use 
...
See \cite{Chen.etal2022}--\cite{b5}.
...
See \cite{Abibullaev.etal2022}.

\end{itemize}

\bibliographystyle{IEEEtran}
\bibliography{lowdensityspatial}
